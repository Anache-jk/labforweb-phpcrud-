...
<body class = "position-relative">
    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <a href = "viewtable.php" style="text-decoration: none;font-size: 15px"> Здесь вы можете добавить покойничка! </a>
            ...
            <div class="d-flex flex-row justify-content-end ">
                ...
                if(!$_SESSION['check']){
                    echo "<div class = 'd-flex flex-column align-items-center justify-content-center'><div class = 'text-center'><div class='font-weight-bold'>ВЫ НЕ АВТОРИЗОВАНЫ</div><a href='autorization.php'>Войти</a></div><div class = 'text-center'> | или | </div><div><a href='registration.php'>Зарегистрироваться</a></div></div> </div>";
                }
                else{
                    echo "<form method = 'post' class = 'd-flex align-items-center justify-content-center'><div class = 'h-1 text-center' style='font-size: 15px'>Вы вошли как: ".$_SESSION['login']."</div><div class = 'w-50 mx-auto'><button name = 'exit' type = 'submit'class = 'btn btn-info buttons' style='color:black'>Выйти</button></div></form>";
                }
...
<div class = "container d-flex flex-column">
    ...
    <div class = "position-fixed p-2" style = "bottom: 20%; right: 0;">
        <div class = "pb-1 mess"><button type="button" class="btn btn-info" ><div class = "d-flex flex-row w-2"> <a href="export.php"><div class = "pl-4"style = "color:white">Экспорт БД здесь</div></a></div></button></div>
        <div class = "pb-1 mess"><button type="button" class="btn btn-info" ><div class = "d-flex flex-row w-2"> <a href="import.php"><div class = "pl-4"style = "color:white">Импорт в БД здесь</div></a></div></button></div>
    </div>
