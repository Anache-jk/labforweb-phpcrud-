...
<? include('header.php');?>
    <div class = "d-flex container-xxl justify-content-center p-4 ">
        <form enctype="multipart/form-data" action="" method = "post" class="form">
            ...
            <input type="file" name = "imgpog" value = "<?php if(!deadhuman['img']){echo $_SERVER['DOCUMENT_ROOT'] . '/imgall/deadimg/'. $data[0][1];}else{echo $_SERVER['DOCUMENT_ROOT'] .'/imgall/deadimg/'. $deadhuman['img'];} ?>">
