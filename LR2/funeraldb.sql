...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 26 2021 г., 07:15
...
INSERT INTO `deadpeople` (`id`, `imgsource`, `firstsecondthird_name`, `id_earth`, `date_and_time`, `num_audience`) VALUES
...
--
ALTER TABLE `deadpeople`
  ADD CONSTRAINT `foreign_key_1` FOREIGN KEY (`id_earth`) REFERENCES `place` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
